...
class DatabaseSeeder {
  ...
  static Future<void> _seedJobs() async {
    ...
    await repo.createJob(
      Job(
        ...
        country: 'Algeria',
        description:
            'Deep cleaning needed for a 3-bedroom apartment. Focus on kitchen and bathrooms.',
        status: JobStatus.active,
    ...
    await repo.createJob(
      Job(
        ...
        country: 'Algeria',
        description:
            'Weekly office cleaning service for a small business. Need reliable and professional service.',
        status: JobStatus.active,
        postedDate: now.subtract(const Duration(days: 2)),
        jobDate: now.add(const Duration(days: 5)),
        clientId: clientId,
    ...
    await repo.createJob(
      Job(
        ...
        country: 'Algeria',
        description:
            'Complete deep cleaning for a large villa. All rooms including windows and outdoor areas.',
        status: JobStatus.active,
  ...
  static Future<void> _seedCleaningHistory() async {
    ...
    final cleaner = profiles.firstWhere(
      (p) =>
          p['user_type'] == 'Individual Cleaner' &&
          p['full_name'] == 'Fatima Zahra',
  ...
  static Future<void> _seedCleanerReviews() async {
    ...
    await repo.addReview(
      CleanerReview(
        ...
        comment:
            'Fatima was amazing! She left my apartment sparkling clean. Very professional and friendly.',
        hasPhotos: false,
      ),
    );
    ...
    await repo.addReview(
      CleanerReview(
        ...
        comment:
            'Excellent work! My house has never been cleaner. Fatima paid attention to every detail.',
        hasPhotos: true,
